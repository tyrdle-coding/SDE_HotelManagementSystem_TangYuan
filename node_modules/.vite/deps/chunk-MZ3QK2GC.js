...
var PremountedPostmountedSequenceRefForwardingFunction = (props, ref) => {
  ...
  const premountContextValue = (0, import_react19.useMemo)(() => {
    return {
  ...
  return (0, import_jsx_runtime11.jsx)(PremountContext.Provider, {
    value: premountContextValue,
    children: (0, import_jsx_runtime11.jsx)(Freeze, {
      frame: freezeFrame,
...
var useSingletonAudioContext = ({
  ...
  const env = useRemotionEnvironment();
  const audioContext = (0, import_react41.useMemo)(() => {
    if (env.isRendering) {
      return null;
    }
    if (!audioEnabled) {
...
var SharedAudioContextProvider = ({ children, numberOfAudioTags, audioLatencyHint, audioEnabled }) => {
  ...
  const scheduleAudioNode = (0, import_react40.useMemo)(() => {
    return ({
      ...
      const bufferDuration = ((_a = node.buffer) == null ? void 0 : _a.duration) ?? 0;
  ...
  return (0, import_jsx_runtime18.jsxs)(SharedAudioContext.Provider, {
    value,
    children: [
      refs.map(({ id, ref }) => {
...
var useSharedAudio = ({
  ...
  const ctx = (0, import_react40.useContext)(SharedAudioContext);
...
var AudioRefForwardingFunction = (props, ref) => {
  const audioContext = (0, import_react33.useContext)(SharedAudioContext);
  const {
    startFrom,
    endAt,
    trimBefore,
...
var ImgInner = ({
  ...
  const didGetError = (0, import_react56.useCallback)((e) => {
    ...
    try {
      cancelRender2("Error loading image with src: " + ((_g = imageRef.current) == null ? void 0 : _g.src));
    } catch {
    }
...
//# sourceMappingURL=chunk-MZ3QK2GC.js.map
