...
var useBrowserMediaSession = ({
  ...
  const hasEverPlayed = (0, import_react7.useRef)(false);
...
var RenderWarningIfBlacklist = () => {
  const [unlicensed, setUnlicensed] = import_react14.default.useState(false);
...
var DefaultVolumeSlider = ({
  ...
  const sliderContainer = (0, import_react17.useMemo)(() => {
    const paddingLeft = 5;
    const common = {
      paddingLeft,
      height: ICON_SIZE,
  ...
  const randomId = typeof import_react17.default.useId === "undefined" ? "volume-slider" : import_react17.default.useId();
  const [randomClass] = (0, import_react17.useState)(() => `__remotion-volume-slider-${random(randomId)}`.replace(".", ""));
  const onVolumeChange = (0, import_react17.useCallback)((e) => {
...
var MediaVolumeSlider = ({ displayVerticalVolumeSlider, renderMuteButton, renderVolumeSlider }) => {
  ...
  const parentDivRef = (0, import_react16.useRef)(null);
  ...
  const parentDivStyle = (0, import_react16.useMemo)(() => {
    return {
      display: "inline-flex",
      background: "none",
      border: "none",
  ...
  const volumeContainer = (0, import_react16.useMemo)(() => {
    return {
      display: "inline",
      width: ICON_SIZE,
      height: ICON_SIZE,
  ...
  const renderDefaultMuteButton = (0, import_react16.useCallback)(({ muted, volume }) => {
  ...
  const muteButton = (0, import_react16.useMemo)(() => {
  ...
  const volumeSlider = (0, import_react16.useMemo)(() => {
...
function useComponentVisible(initialIsVisible) {
  const [isComponentVisible, setIsComponentVisible] = (0, import_react19.useState)(initialIsVisible);
...
var PlaybackrateOption = ({ rate, onSelect, selectedRate, keyboardSelectedRate }) => {
  const onClick = (0, import_react18.useCallback)((e) => {
    e.stopPropagation();
    e.preventDefault();
    onSelect(rate);
  }, [onSelect, rate]);
  ...
  const actualStyle = (0, import_react18.useMemo)(() => {
    return {
      ...rateDiv,
...
var PlaybackPopup = ({ setIsComponentVisible, playbackRates, canvasSize }) => {
  ...
  const [keyboardSelectedRate, setKeyboardSelectedRate] = (0, import_react18.useState)(playbackRate);
  ...
  const onSelect = (0, import_react18.useCallback)((rate) => {
    setPlaybackRate(rate);
    setIsComponentVisible(false);
  }, [setIsComponentVisible, setPlaybackRate]);
  const playbackPopup = (0, import_react18.useMemo)(() => {
    return {
      position: "absolute",
      right: 0,
      width: 125,
...
var PlayerSeekBar = ({ durationInFrames, onSeekEnd, onSeekStart, inFrame, outFrame }) => {
  ...
  const frame = Internals.Timeline.useTimelinePosition();
  const [dragging, setDragging] = (0, import_react20.useState)({
    dragging: false
  });
  ...
  const onPointerMove = (0, import_react20.useCallback)((e) => {
    var _a;
    if (!size) {
  ...
  const onPointerUp = (0, import_react20.useCallback)(() => {
    setDragging({
      dragging: false
    });
    if (!dragging.dragging) {
  ...
  const knobStyle = (0, import_react20.useMemo)(() => {
    return {
      height: KNOB_SIZE2,
      width: KNOB_SIZE2,
  ...
  const fillStyle = (0, import_react20.useMemo)(() => {
    return {
      height: BAR_HEIGHT2,
...
var PlayerTimeLabel = ({ durationInFrames, maxTimeLabelWidth, fps }) => {
  const frame = Internals.Timeline.useTimelinePosition();
  const timeLabel = (0, import_react21.useMemo)(() => {
    return {
      color: "white",
...
var useVideoControlsResize = ({
  ...
  const resizeInfo = (0, import_react22.useMemo)(() => {
...
var Controls = ({
  ...
  const playButtonRef = (0, import_react15.useRef)(null);
  const [supportsFullscreen, setSupportsFullscreen] = (0, import_react15.useState)(false);
  const hovered = useHoverState(containerRef, hideControlsWhenPointerDoesntMove);
  const { maxTimeLabelWidth, displayVerticalVolumeSlider } = useVideoControlsResize({
    allowFullscreen,
    playerWidth: (canvasSize == null ? void 0 : canvasSize.width) ?? 0
  });
  const [shouldShowInitially, setInitiallyShowControls] = (0, import_react15.useState)(() => {
  ...
  const containerCss = (0, import_react15.useMemo)(() => {
  ...
  const playbackRates = (0, import_react15.useMemo)(() => {
  ...
  const flexRef = (0, import_react15.useRef)(null);
  const onPointerDownIfContainer = (0, import_react15.useCallback)((e) => {
    if (e.target === ref.current || e.target === flexRef.current) {
      onPointerDown == null ? void 0 : onPointerDown(e);
    }
  }, [onPointerDown]);
  const onDoubleClickIfContainer = (0, import_react15.useCallback)((e) => {
    if (e.target === ref.current || e.target === flexRef.current) {
